...
const Upload: NextPage = () => {
  return (
    <div className="px-4 py-16">
      <div>
        <div className="w-full cursor-pointer text-gray-600 hover:border-orange-500 hover:text-orange-500 flex items-center justify-center border-2 border-dashed border-gray-300 h-48 rounded-md">
          <label>
            <svg
              className="h-12 w-12"
              stroke="currentColor"
      ...
      <div className="my -5">
        ...
        <div className="rounded-md mb-4 shadow-sm relative flex items-center">
